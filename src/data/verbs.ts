...
export const verbs: Verb[] = [
  ...
  },
  {
    ...
    english: 'to find',
    category: 'irregular',
    conjugation: { ich: 'finde', du: 'findest', erSieEs: 'findet', wir: 'finden', ihr: 'findet', Sie: 'finden' },
    example: { de: 'Ich finde meinen Schlüssel nicht.', en: "I can't find my key." },
  },
  {
    infinitive: 'helfen',
    english: 'to help',
    category: 'irregular',
    conjugation: { ich: 'helfe', du: 'hilfst', erSieEs: 'hilft', wir: 'helfen', ihr: 'helft', Sie: 'helfen' },
  ...
  },
  {
    ...
    category: 'irregular',
    conjugation: { ich: 'steige ein', du: 'steigst ein', erSieEs: 'steigt ein', wir: 'steigen ein', ihr: 'steigt ein', Sie: 'steigen ein' },
    example: { de: 'Wir steigen in den Zug ein.', en: 'We get on the train.' },
  },
  {
    infinitive: 'aussteigen',
    english: 'to get off',
    category: 'irregular',
    conjugation: { ich: 'steige aus', du: 'steigst aus', erSieEs: 'steigt aus', wir: 'steigen aus', ihr: 'steigt aus', Sie: 'steigen aus' },
    example: { de: 'Ich steige am Hauptbahnhof aus.', en: 'I get off at the main station.' },
  },
  {
    infinitive: 'umsteigen',
    english: 'to change / transfer (transport)',
    category: 'irregular',
    conjugation: { ich: 'steige um', du: 'steigst um', erSieEs: 'steigt um', wir: 'steigen um', ihr: 'steigt um', Sie: 'steigen um' },
    example: { de: 'Du musst in Köln umsteigen.', en: 'You have to change trains in Cologne.' },
  },
  {
  ...
  },
  {
    ...
    category: 'regular',
    conjugation: { ich: 'suche', du: 'suchst', erSieEs: 'sucht', wir: 'suchen', ihr: 'sucht', Sie: 'suchen' },
    example: { de: 'Ich suche meine Brille.', en: 'I am looking for my glasses.' },
  },
  {
    infinitive: 'hören',
    english: 'to hear / listen',
    category: 'regular',
    conjugation: { ich: 'höre', du: 'hörst', erSieEs: 'hört', wir: 'hören', ihr: 'hört', Sie: 'hören' },
  ...
  },
  {
    ...
    english: 'to pay',
    category: 'regular',
    conjugation: { ich: 'zahle', du: 'zahlst', erSieEs: 'zahlt', wir: 'zahlen', ihr: 'zahlt', Sie: 'zahlen' },
    example: { de: 'Ich zahle mit Karte.', en: 'I pay by card.' },
  },
  {
    infinitive: 'einkaufen',
    english: 'to shop / go shopping',
    category: 'regular',
    conjugation: { ich: 'kaufe ein', du: 'kaufst ein', erSieEs: 'kauft ein', wir: 'kaufen ein', ihr: 'kauft ein', Sie: 'kaufen ein' },
    example: { de: 'Am Samstag kaufe ich ein.', en: 'On Saturday I go shopping.' },
  },
  {
    infinitive: 'abholen',
    english: 'to pick up',
    category: 'regular',
    conjugation: { ich: 'hole ab', du: 'holst ab', erSieEs: 'holt ab', wir: 'holen ab', ihr: 'holt ab', Sie: 'holen ab' },
    example: { de: 'Ich hole dich vom Bahnhof ab.', en: 'I will pick you up from the station.' },
  },
  {
    infinitive: 'aufräumen',
    english: 'to tidy up',
    category: 'regular',
    conjugation: { ich: 'räume auf', du: 'räumst auf', erSieEs: 'räumt auf', wir: 'räumen auf', ihr: 'räumt auf', Sie: 'räumen auf' },
    example: { de: 'Er räumt sein Zimmer auf.', en: 'He is tidying up his room.' },
  },
]
